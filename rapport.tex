...
Nous poursuivons avec le diagramme d'états présenté dans la figure \ref{sdml}.  Il décrit les différents états qui constituent le développement de notre modèle machine learning. Voici un bref résumé de ce fait chaque état: 
