...
\begin{table}[h]
	...
	\begin{tabular}{|l|c|c|c|c|c|}
		...
		\hline
	\end{tabular}
	\caption{Comparison of the algorithms of ensemble method used in our project}
	\label{tab:ensemble}
\end{table}
