...
est le vecteur défini de la façon suivante : $\vec{X} = \begin{bmatrix}x_1, x_2, x_3, x_4  \end{bmatrix}$ où $x_1$ représente le code, $x_2$ la description, $x_3$ le type et $x_4$ la date d'expiration. La variable cible est la quantité vendue, c'est celle qu'on veut prédire. La matrice  $A_{5,4}$ est définie comme suit: \\
$A_{5,4} =  
 \begin{pmatrix} 
